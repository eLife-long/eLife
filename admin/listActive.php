...
$keywordsBy=$keywords?"where (a.`aName` like '%{$keywords}%' OR s.`sName` like '%{$keywords}%')":null;
//(a.`aName` like '%{$keywords}%' OR s.`sName` like '%{$keywords}%')
$where="$keywordsBy $orderBy";
$rows=getActiveByPage($page, $pageSize,$where);
 //var_dump($rows);
if(!$rows){
    alertMes("sorry,没有活动,请添加！", "addActive.php");
}
?>
<!doctype html>
<html>
                            ...
                            <tr>
                                ...
                                <td align="center">
					                        	...
					                        	<table class="table" cellspacing="0" cellpadding="0">
					                        		...
					                        		<tr>
					                        			<td width="20%"  align="right">所属商店</td>
					                        			<td><?php echo $row['sName'];?></td>
					                        		</tr>
					                        		<tr>
