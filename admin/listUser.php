                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php  foreach($rows as $row):?>
                            <tr>
                                ...
                                <td><input type="checkbox" id="c1" class="check"><label for="c1" class="label"><?php echo $row['id'];?><img height=20px,width=30px src="../uploads/<?php echo $row['face'];?>" /></label></td>
                            ...
                            <?php endforeach;?>
							<?php if($UtotalRows>$pageSize):?>
							<tr>
								<td colspan="4"><?php echo showPage($page, $UtotalPage)?></td>
							</tr>
							<?php endif;?>                            
                        </tbody>
                    </table>
